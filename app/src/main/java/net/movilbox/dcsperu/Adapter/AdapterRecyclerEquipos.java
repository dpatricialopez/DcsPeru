...
import net.movilbox.dcsperu.Activity.ActDetalleComboPedir;
...
import net.movilbox.dcsperu.Entry.RowViewHolderCombo;
...
public class AdapterRecyclerEquipos extends RecyclerView.Adapter<RowViewHolderCombo> {

    private Activity context;
    private List<ReferenciasEquipos> responseHomeList;
    ...
    public AdapterRecyclerEquipos(Activity context, List<ReferenciasEquipos> responseHomeList, int idpos, int iduser) {
        super();
    ...
    public void onBindViewHolder(final RowViewHolderCombo holder, final int position) {
        ...
        final ReferenciasEquipos items = responseHomeList.get(position);
