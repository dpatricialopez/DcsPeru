...
import static net.movilbox.dcsperu.Entry.ResponseHome.getResponseHomeListS;
...
public class ActReporteRutero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppAdapterRutero appAdapterRutero = new AppAdapterRutero(this, (ListHome) getResponseHomeListS(), "busqueda");
...
// step 2. listener item click event
    ...
    private void cargarDetalle(int position) {
        ...
        cod_cum.setText(String.format("%1$s", getResponseHomeListS().get(position).getCod_cum()));
